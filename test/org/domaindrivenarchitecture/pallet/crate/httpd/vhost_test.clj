...
"worker.list=liferay-worker"
"worker.liferay-worker.port=8009"
"worker.liferay-worker.host=127.0.0.1"
"worker.liferay-worker.type=ajp13"
"worker.liferay-worker.socket_timeout=900"
"worker.liferay-worker.socket_keepalive=false"
"worker.liferay-worker.connection_pool_timeout=100"])
